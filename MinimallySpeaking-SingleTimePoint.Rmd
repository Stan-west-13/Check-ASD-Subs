...
match_final_mo <- matchit(group~nProduced, data = df_matched_o |>
...
match_final_ym <- matchit(group~nProduced, data = df_matched_o |>
                            filter(group == "mdl" | group == "yng"),
                  distance = "glm",
                  method = "optimal"
                 )
...
df_final %>% group_by(group) %>% summarize(m_nprod = mean(nProduced))
